...
SRCS_EXECUTION			= execute_cmd.c execution_or_and.c execute_path.c execution.c execution_fork.c \
 						  ...
 						  execution_heredoc_utils.c execution_heredoc_read_write.c execution_verif.c
...
SRCS_PARSING			= ast_management.c parsing.c parsing_mandatory.c parsing_redirection.c parsing_bonus.c parsing_utils.c

SRCS_PARSING_TOKENIZER	= tokenizer.c token_management.c tokenizer_quote_handler.c split_with_quote.c split_quote_utils.c
