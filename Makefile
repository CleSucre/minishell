...
SRCS_EXECUTION			= execute_cmd.c execution_or_and.c execution_types.c execute_path.c execution.c execution_fork.c signal_handler.c redirections_input.c redirections_output.c pipes.c
